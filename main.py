...
API_ID = "23392712"
API_HASH = "7cb236b197b25c243fa83e7e0173d0e6"
...
async def chatbotofd(client, message):
    ...
    if not is_Chiku:
        Chiku.insert_one({"chat_id": message.chat.id})
...
async def chatboton(client, message):
    ...
    if is_Chiku:
        Chiku.delete_one({"chat_id": message.chat.id})
...
async def Chikuai(client: Client, message: Message):
...
async def Chikustickerai(client: Client, message: Message):
...
async def Chikuprivate(client: Client, message: Message):
...
async def Chikuprivatesticker(client: Client, message: Message):
